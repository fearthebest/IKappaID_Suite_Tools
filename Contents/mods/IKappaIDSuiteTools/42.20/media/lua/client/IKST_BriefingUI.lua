...
function IKST_BriefingUI.open(player, sectionId)
    ...
    if IKST_BriefingUI.instance then
        ...
        if sectionId and IKST_BriefingUI.instance.showSection then
            IKST_BriefingUI.instance:showSection(sectionId)
        end
        return
    end
    ...
    if IKST_BriefingUI._cache then
        ...
        IKST.dispatchCommand(player, IKST.CMD.briefingFetch, { sectionId = sectionId })
    end
end
