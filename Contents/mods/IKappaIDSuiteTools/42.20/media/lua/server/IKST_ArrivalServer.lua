...
local function playerKey(player)
    return IKST_ServerPlayers.playerKey(player)
end
...
function IKST_ArrivalServer.enforce(player)
    ...
    if IKST_Arrival.attackEndsGrace() and type(player.isAttackStarted) == "function" and player:isAttackStarted() then
...
local function foreachOnlinePlayer(fn)
    IKST_ServerPlayers.foreachOnlinePlayer(fn)
end
