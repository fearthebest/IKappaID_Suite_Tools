...
-- Staff may always create claims. Players may create only if the operator
-- explicitly opts into unsupervised self-service.
function IKST_ClaimPolicy.mayCreateClaim(player)
    ...
    return IKST_ClaimPolicy.playerClaimsEnabled()
end
