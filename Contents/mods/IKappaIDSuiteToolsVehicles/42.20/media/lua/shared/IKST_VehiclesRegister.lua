...
-- SoftTool_Vehicle lives in lua/client and auto-loads after shared.
...
local VEHICLE_TOOLS = {
    {
        ...
        id = "overview",
        titleKey = "IGUI_IKST_Vehicles_Overview",
        title = "Overview",
        order = 5,
    },
    {
