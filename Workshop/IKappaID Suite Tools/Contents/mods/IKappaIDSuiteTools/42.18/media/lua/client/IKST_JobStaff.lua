...
function IKST_JobStaff.build(panel)
    ...
    elseif state.staffMode == "waypoints" then
        ...
        panel:makeJobButton(180, y, 80, 22, IKST.text("IGUI_IKST_WaypointSave", "Save here"), function()
        ...
        panel:makeJobButton(266, y, 70, 22, IKST.text("IGUI_IKST_WaypointDel", "Delete"), function()
